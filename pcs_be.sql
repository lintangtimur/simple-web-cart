...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2023 at 04:33 PM
...
(5, '2023_11_22_073738_create_products_table', 1),
(6, '2023_11_22_073744_create_cart_items_table', 2),
(7, '2023_11_22_073752_create_transactions_table', 2),
(8, '2023_11_22_073758_create_transaction_details_table', 2),
(9, '2023_11_22_073805_create_coupons_table', 2);
...
(1, 'laptop', '1000000.00', NULL, NULL),
(2, 'mouse', '30000.00', NULL, NULL),
(3, 'keyboard', '60000.00', NULL, NULL),
(4, 'mousepad', '200000.00', NULL, NULL),
(5, 'kursi', '150000.00', NULL, NULL);
...
CREATE TABLE `transactions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `transaction_date` timestamp NOT NULL DEFAULT '2023-11-22 01:17:31',
...
(1, 'lintang', 'lintang@gmail.com', NULL, '$2y$12$EsBhwE6FqvH2pgCQ1bzeuOBibCWgDTamDBQ.opPTPT.k4RS8Fsxkq', NULL, NULL, NULL);
